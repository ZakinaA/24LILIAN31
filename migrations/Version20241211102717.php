 ...
 */
final class Version20241211102717 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paiement ADD CONSTRAINT FK_B1DC7A1E53C59D72 FOREIGN KEY (responsable_id) REFERENCES responsable (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE responsable ADD CONSTRAINT FK_52520D07C8D8BF3D FOREIGN KEY (quotient_familial_id) REFERENCES quotient_familial (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE tarif ADD CONSTRAINT FK_E7189C9C8D8BF3D FOREIGN KEY (quotient_familial_id) REFERENCES quotient_familial (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE tarif ADD CONSTRAINT FK_E7189C9B3305F4C FOREIGN KEY (type_cours_id) REFERENCES type_cours (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
